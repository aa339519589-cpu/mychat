...
function ProjectCard({ project, conversationCount, onOpen, onDelete }: {
  ...
  return (
    <div className="group relative rounded-2xl border border-border bg-card transition-colors hover:border-border hover:bg-card/90">
      <button
  ...
  return (
    <div className="space-y-5 px-4">
      ...
      <section>
        ...
        {chats.length === 0 ? (
          <p className="rounded-2xl border border-border bg-card px-4 py-6 text-center text-[12px] italic text-muted-foreground/70">还没有对谈，从上方开始第一段</p>
        ) : (
