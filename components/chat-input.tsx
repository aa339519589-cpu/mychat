...
export function ChatInput({
  ...
  return (
    <div className={cn("relative z-10 mx-auto w-full shrink-0", mobile ? "bg-background px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2" : "max-w-[56rem] px-10 pb-8 pt-2")}>
      ...
      <div className="flex min-w-0 flex-wrap items-center gap-x-0.5 rounded-[1.7rem] border border-border bg-card px-2.5 pb-2 pt-2.5 text-card-foreground shadow-[0_4px_16px_rgba(8,8,8,0.045)] transition-[border-color,box-shadow] duration-150 focus-within:border-[#D9D4CA] focus-within:shadow-[0_6px_20px_rgba(8,8,8,0.07)] dark:border-white/10 dark:bg-[#151515] dark:text-white dark:focus-within:border-white/20 sm:gap-x-1 sm:px-3">
