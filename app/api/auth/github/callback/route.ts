...
export async function GET(req: NextRequest) {
  ...
  if (!auth.userId) return Response.redirect(`${home}?github=error`)
  ...
  const cookieOpts = 'HttpOnly; Secure; SameSite=Lax; Path=/; Max-Age=2592000' // 30 天
  ...
  headers.append('Set-Cookie', `gh_user_id=${auth.userId}; ${cookieOpts}`)
